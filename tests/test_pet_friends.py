...
'''def test_add_new_pet_with_valid_data(name='Malt', animal_type='мальтийская болонка',
                                     age='1', pet_photo='images/maltese lapdog.jpg'):'''
...
def test_successful_update_self_pet_info(name='Toby', animal_type='dog', age=3):
    ...
    def test_get_all_pets_with_not_valid_key(filter=''):
        """ Проверка получение списка питомца с невалидным auth_key """
